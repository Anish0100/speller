...
const audio = document.getElementById('German');
...
function replaybtn() {
  document.getElementById("german.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "german.html"; // Redirect to home page
}

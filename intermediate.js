...
function replaybtn() {
  document.getElementById("intermediate.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "intermediate.html"; // Redirect to home page
}

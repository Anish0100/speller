...
const audio = document.getElementById('dutch');
...
function replaybtn() {
  document.getElementById("dutch.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "dutch.html"; // Redirect to home page
}

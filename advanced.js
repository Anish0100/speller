...
function replaybtn() {
  document.getElementById("advanced.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "advanced.html"; // Redirect to home page
}

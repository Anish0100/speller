...
function replaybtn() {
  document.getElementById("wordsmith.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "wordsmith.html"; // Redirect to home page
}
...
function showResult() {
  function showResults() {
    ...
    // Calculate the score
    let score = Math.round(scoreCounter / words.length * 200);
...
spellCheck.addEventListener('click', () => {
  ...
  window.location.href = 'wordsmith.html';
  });

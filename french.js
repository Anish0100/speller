...
const audio = document.getElementById('french');
...
function replaybtn() {
  document.getElementById("french.html").reset(); // Reset form
  document.getElementById("result").innerHTML = ""; // Clear result message
  window.location.href = "french.html"; // Redirect to home page
}
